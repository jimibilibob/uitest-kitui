...
#ifndef UITEST_POC_SWIFT_H
#define UITEST_POC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UITest_PoC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10UITest_PoC11AppDelegate")
...
SWIFT_CLASS("_TtC10UITest_PoC13SceneDelegate")
...
SWIFT_CLASS("_TtC10UITest_PoC14ViewController")
